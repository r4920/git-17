...
struct IncomingCallNotification1View: View {
    @StateObject var incomingCallNotification1ViewModel = IncomingCallNotification1ViewModel()
        ...
        VStack {
            VStack {
                VStack {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        VStack {
                            ScrollView(.horizontal, showsIndicators: false) {
                                HStack {
                                    HStack {
                                        TextField(StringConstants.kLblOpenChat, text: $incomingCallNotification1ViewModel.openchatText)
                                            .font(Font.system(size: getRelativeHeight(size: 13.0)))
                                            .foregroundColor(ColorConstants.WhiteA700)
                                            .padding()
                                    }
                                    .frame(width: getRelativeWidth(size: 95.0), height: getRelativeHeight(size: 31.0), alignment: .center)
                                    .overlay(RoundedCorners(topLeft: 15.2, topRight: 15.2, bottomLeft: 15.2, bottomRight: 15.2).stroke(ColorConstants.Blue400, lineWidth: 1))
                                    .background(RoundedCorners(topLeft: 15.2, topRight: 15.2, bottomLeft: 15.2, bottomRight: 15.2).fill(ColorConstants.Blue400))
                                    Button(action: {}, label: {
                                        Text(StringConstants.kMsgILlCallYouL)
                                            .font(Font.system(size: getRelativeHeight(size: 13.0)))
                                            .foregroundColor(ColorConstants.Gray900)
                                            .frame(width: getRelativeWidth(size: 116.0), height: getRelativeHeight(size: 31.0), alignment: .center)
                                    })
                                    .frame(width: getRelativeWidth(size: 116.0), height: getRelativeHeight(size: 31.0), alignment: .center)
                                    .overlay(RoundedCorners(topLeft: 15.2, topRight: 15.2, bottomLeft: 15.2, bottomRight: 15.2).stroke(ColorConstants.Gray100, lineWidth: 1))
                                    .background(RoundedCorners(topLeft: 15.2, topRight: 15.2, bottomLeft: 15.2, bottomRight: 15.2).fill(Color.clear.opacity(0.7)))
                                    .padding(.leading, getRelativeWidth(size: 8.0))
                                    Button(action: {}, label: {
                                        Text(StringConstants.kMsgCanTTalkNow)
                                            .font(Font.system(size: getRelativeHeight(size: 13.0)))
                                            .foregroundColor(ColorConstants.Gray900)
                                            .frame(width: getRelativeWidth(size: 196.0), height: getRelativeHeight(size: 31.0), alignment: .center)
                                    })
                                    .frame(width: getRelativeWidth(size: 196.0), height: getRelativeHeight(size: 31.0), alignment: .center)
                                    .overlay(RoundedCorners(topLeft: 15.2, topRight: 15.2, bottomLeft: 15.2, bottomRight: 15.2).stroke(ColorConstants.Gray100, lineWidth: 1))
                                    .background(RoundedCorners(topLeft: 15.2, topRight: 15.2, bottomLeft: 15.2, bottomRight: 15.2).fill(Color.clear.opacity(0.7)))
                                ...
                                .frame(width: getRelativeWidth(size: 320.0), height: getRelativeHeight(size: 31.0), alignment: .leading)
                            }
                            .padding(.horizontal, getRelativeWidth(size: 12.0))
                        }
                        .frame(width: getRelativeWidth(size: 344.0), height: getRelativeHeight(size: 31.0), alignment: .center)
                        .padding(.top, getRelativeHeight(size: 10.0))
                        VStack(alignment: .leading, spacing: 0) {
                            Image("img_swipeupwide_1")
                                .resizable()
                    ...
                    .frame(width: getRelativeWidth(size: 344.0), height: getRelativeHeight(size: 135.0), alignment: .center)
                ...
                .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(size: 135.0), alignment: .center)
                VStack(alignment: .leading, spacing: 0) {
                                    ...
                                    HStack {
                                        ...
                                        VStack {
                                            ...
                                            VStack(alignment: .leading, spacing: 0) {
                                                VStack {
                                                    HStack(spacing: 0) {
                                                        TextField(StringConstants.kLblOkay, text: $incomingCallNotification1ViewModel.okayText)
                                    ...
                                    HStack {
                                        ...
                                        VStack {
                                            ...
                                            VStack(alignment: .leading, spacing: 0) {
                                                VStack {
                                                    HStack(spacing: 0) {
                                                        TextField(StringConstants.kMsgIWillVoteFor, text: $incomingCallNotification1ViewModel.iwillvoteforText)
                                                            .font(Font.system(size: getRelativeHeight(size: 15.0)))
                                                            .foregroundColor(ColorConstants.Bluegray400)
                                                            .padding()
                                                    }
                                    ...
                                    HStack {
                                        ...
                                        VStack {
                                            ...
                                            VStack(alignment: .leading, spacing: 0) {
                                                VStack {
                                                    HStack(spacing: 0) {
                                                        TextField(StringConstants.kMsgWillItEverHa, text: $incomingCallNotification1ViewModel.williteverhaText)
                                                            .font(Font.system(size: getRelativeHeight(size: 15.0)))
                                                            .foregroundColor(ColorConstants.Bluegray400)
                                                            .padding()
                                                    }
...
struct IncomingCallNotification1View_Previews: PreviewProvider {

...
struct IncomingCallNotificationView: View {
    @StateObject var incomingCallNotificationViewModel = IncomingCallNotificationViewModel()
                                    ...
                                    HStack {
                                        ...
                                        VStack {
                                            ...
                                            VStack(alignment: .leading, spacing: 0) {
                                                VStack {
                                                    HStack(spacing: 0) {
                                                        TextField(StringConstants.kLblOkay, text: $incomingCallNotificationViewModel.okayText)
                                    ...
                                    HStack {
                                        ...
                                        VStack {
                                            ...
                                            VStack(alignment: .leading, spacing: 0) {
                                                VStack {
                                                    HStack(spacing: 0) {
                                                        TextField(StringConstants.kMsgIWillVoteFor, text: $incomingCallNotificationViewModel.iwillvoteforText)
                                                            .font(Font.system(size: getRelativeHeight(size: 15.0)))
                                                            .foregroundColor(ColorConstants.Bluegray400)
                                                            .padding()
                                                    }
                                    ...
                                    HStack {
                                        ...
                                        VStack {
                                            ...
                                            VStack(alignment: .leading, spacing: 0) {
                                                VStack {
                                                    HStack(spacing: 0) {
                                                        TextField(StringConstants.kMsgWillItEverHa, text: $incomingCallNotificationViewModel.williteverhaText)
                                                            .font(Font.system(size: getRelativeHeight(size: 15.0)))
                                                            .foregroundColor(ColorConstants.Bluegray400)
                                                            .padding()
                                                    }
